      ...
      <nav className='flex flex-col justify-between sticky top-20'>
        {menus.map(menu => (
          <Link href={menu.path} key={menu.key}>
            <a
              className={classNames('h-[42px] flex items-center px-4 mb-3 hover:bg-bg-100 hover:text-blue rounded overflow-hidden will-change-auto transition-all duration-200', {
                'bg-bg-100 text-blue': router.asPath === menu.path
              })}
